...
import { CreatorUpgradeModal } from "@/app/[locale]/my/components/creator-upgrade-modal";
import { PlatformUpgradeModal } from "@/app/[locale]/my/components/platform-upgrade-modal";
import {
  checkUser,
  PlatformType,
  UserSearchResult,
                    ...
                    return (
                      ...
                      >
                        ...
                        <Center mt="xs">
                          <Button
                            component={Link}
                            href={getMyProfileUrl(user as never)}
                            variant="subtle"
                            size="compact-sm"
                          >
                            {t("actions.viewPage")}
