...
export function Navbar({
  ...
  const searchContent = collapsed ? (
    <Tooltip label={t("actions.searchPlaceholder")} position="right" withArrow>
      <ActionIcon
        ...
        onClick={(e: React.MouseEvent<HTMLAnchorElement>) =>
          handleLinkClick(e, "/my/search")
        }
        style={{
          border: pathname.includes("/my/search") ? "1px solid gold" : undefined,
        }}
      >
        <IconLink size={24} />
      </ActionIcon>
    ...
    <Link
      ...
      onClick={(e) => handleLinkClick(e, "/my/search")}
    >
      <Paper
        p="xs"
        radius="md"
