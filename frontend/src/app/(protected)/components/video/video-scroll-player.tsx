...
export function VideoScrollPlayer({
  ...
  useEffect(() => {
    ...
    if (initialIndex === -1) return; // Don't scroll if not found

    // Only scroll if not the first item (first item is already visible)
    if (initialIndex > 0) {
  ...
  // Use initialIndex for first render, fallback to 0 only when valid
