...
export async function GET(
  ...
  const sourcesWithPlaylists = await fetchPlaylistsFromS3(s3Client, bucket, sources, "original");
...
async function fetchFromS3(s3Client: S3Client, bucket: string, key: string): Promise<string | null> {
