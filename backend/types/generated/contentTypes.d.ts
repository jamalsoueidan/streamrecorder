...
export interface ApiAnnouncementAnnouncement
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['info', 'warning', 'important']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiSourceSource extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    endpoint: Schema.Attribute.Enumeration<
      ['nbg1.your-objectstorage.com', 's3.eu-central-003.backblazeb2.com']
    > &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    pushSubscription: Schema.Attribute.JSON & Schema.Attribute.Private;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    role: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.role'
